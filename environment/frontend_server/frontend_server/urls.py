...
"""
# from django.conf.urls import include, url    #uncomment me back in to reset to default
from django.conf.urls import include    #comment me out to reset to default
from django.urls import re_path as url    #comment me out to reset to default
